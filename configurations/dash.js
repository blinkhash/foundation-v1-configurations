...
// Coin Configuration
config.coin = {};
config.coin.name = 'Dash';
config.coin.symbol = 'DASH';
config.coin.asicBoost = false;
...
config.coin.algorithms.mining = 'x11';
config.coin.algorithms.block = 'x11';
...
config.coin.mainnet.peerMagic = 'bf0c6bbd';
config.coin.mainnet.pubKeyHash = Buffer.from('4C', 'hex').readUInt8(0);
config.coin.mainnet.scriptHash = Buffer.from('10', 'hex').readUInt8(0);
config.coin.mainnet.wif = Buffer.from('cc', 'hex').readUInt8(0);
config.coin.mainnet.coin = 'dash';
...
config.coin.testnet.peerMagic = 'cee2caff';
config.coin.testnet.pubKeyHash = Buffer.from('8C', 'hex').readUInt8(0);
config.coin.testnet.scriptHash = Buffer.from('13', 'hex').readUInt8(0);
config.coin.testnet.wif = Buffer.from('EF', 'hex').readUInt8(0);
config.coin.testnet.coin = 'dash';
