...
// Coin Configuration
config.coin = {};
config.coin.name = 'Litecoin';
config.coin.symbol = 'LTC';
...
config.coin.mainnet.peerMagic = 'fbc0b6db';
config.coin.mainnet.pubKeyHash = Buffer.from('30', 'hex').readUInt8(0);
config.coin.mainnet.scriptHash = Buffer.from('32', 'hex').readUInt8(0);
config.coin.mainnet.wif = Buffer.from('b0', 'hex').readUInt8(0);
config.coin.mainnet.coin = 'ltc';

// Mainnet Configuration
config.coin.testnet = {};
config.coin.testnet.bech32 = 'tltc';
...
config.coin.testnet.peerMagic = 'fcc1b7dc';
config.coin.testnet.pubKeyHash = Buffer.from('6F', 'hex').readUInt8(0);
config.coin.testnet.scriptHash = Buffer.from('3A', 'hex').readUInt8(0);
config.coin.testnet.wif = Buffer.from('EF', 'hex').readUInt8(0);
config.coin.testnet.coin = 'ltc';
